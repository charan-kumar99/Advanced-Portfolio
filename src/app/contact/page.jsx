...
function SocialTicker({ items, direction = 'left', speed = 30, isLowPowerMode = false }) {
    return (
...
export default function ContactPage() {
    ...
    return (
        <div ref={containerRef} className="relative bg-background selection:bg-primary/20">
            ...
            <div className="fixed inset-0 bg-[url('/icons/grid.svg')] bg-center [mask-image:linear-gradient(180deg,white,rgba(255,255,255,0))] pointer-events-none z-0" />
                        ...
                        <div className="col-span-1 lg:col-span-8 flex flex-col gap-16 relative z-10 pt-10 lg:pt-0">
                            ...
                            >
                                <div className="flex flex-col gap-1">
                                    <SocialTicker items={row1Real} direction="right" speed={30} isLowPowerMode={isLowPowerMode} />
                                </div>
                            </motion.div>
