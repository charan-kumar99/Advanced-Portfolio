...
function Bubble({ b, mouseX, mouseY }) {
    ...
    const proximity = useTransform([mouseX, mouseY], ([x, y]) => {
        const d = Math.sqrt(Math.pow(x - center.x, 2) + Math.pow(y - center.y, 2));
...
function FloatingTechBubbles({ mouseX, mouseY }) {
    const bubbles = [
        // LEFT SIDE (Frontend & Core)
        { icon: "dotnetcore", top: "15%", left: "8%", delay: 0.2 },
        { icon: "react", top: "28%", left: "20%", delay: 1.5 },
        { icon: "csharp", top: "45%", left: "6%", delay: 0.7 },
        { icon: "javascript", top: "62%", left: "18%", delay: 2.4 },
        { icon: "html5", top: "78%", left: "10%", delay: 1.1 },

        // RIGHT SIDE (Backend & DevOps)
        { icon: "css3", top: "18%", right: "12%", delay: 0.4 },
        { icon: "microsoftsqlserver", top: "35%", right: "22%", delay: 1.8 },
        { icon: "postgresql", top: "52%", right: "10%", delay: 1.3 },
        { icon: "docker", top: "68%", right: "24%", delay: 2.8 },
        { icon: "github", top: "82%", right: "15%", delay: 0.9 },
    ];
