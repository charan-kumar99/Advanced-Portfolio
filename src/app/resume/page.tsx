...
export default function ResumePage() {
    ...
    // Local Resume URL (Place your resume.pdf in the public folder)
    const resumeUrl = "/documents/Charan_Kumar_Resume.pdf";
    const previewUrl = "/documents/Charan_Kumar_Resume.pdf";
        ...
        <div className="h-screen bg-background relative flex flex-col pt-24 pb-4 overflow-hidden">
            ...
            >
                <div className="w-full h-full bg-muted/30 rounded-2xl border border-border/50 overflow-hidden relative group">
                    ...
                    {/* Always try to load the local resume.pdf */}
                    <iframe
                        src={`${previewUrl}#toolbar=0&navpanes=0&scrollbar=0`}
                        className="w-full h-full border-none relative z-10 transition-all duration-300 pointer-events-auto bg-white"
                        title="Resume Viewer"
                        loading="lazy"
                    />
                </div>
