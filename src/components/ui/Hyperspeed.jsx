...
const FogController = ({ color, paused }) => {
...
const MovingStars = ({ color, paused }) => {
    const count = 100;
    const mesh = useRef(null);
...
const Hyperspeed = ({ effectOptions, className, paused }) => {
    const toHex = (num, defaultColor) => {
