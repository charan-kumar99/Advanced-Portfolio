...
const PROJECT_DATA: ProjectData[] = portfolioData.projects.map((p) => ({
  title: p.title.replace(" - AI GitHub Analyzer", ""), // make it cleaner if needed, or keep it standard
                      ...
                      return (
                        <div key={i} className="minimap-item-info" style={{ top: `${i * 250}px` }}>
                          <div className="minimap-item-info-row">
                            ...
                            <h4 className="text-xl md:text-2xl font-medium tracking-tight uppercase text-right max-w-[30%] leading-tight">
                              {data.title}
                            </h4>
                          </div>
                          <div className="minimap-item-info-row">
                          ...
                          <div className="minimap-item-info-row">
                            <p className="lowercase opacity-80 font-medium leading-relaxed max-w-[30%] text-[10px]">
                              {data.description}
                            </p>
                            <Link 
