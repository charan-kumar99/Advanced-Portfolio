    ...
    <div className={cn("w-full max-w-7xl mx-auto px-4 relative", className)}>
      ...
      <div className='hidden md:flex relative items-center justify-center'>
        ...
        <motion.div
          ...
          className={cn(
            'bg-white dark:bg-[#161616] rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.1)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.5)] p-10 z-10 w-[600px] border border-black/5 dark:border-white/5 flex flex-col justify-center',
            imageUrl ? 'ml-[-100px]' : ''
          )}
        >
          <div className='mb-6'>
