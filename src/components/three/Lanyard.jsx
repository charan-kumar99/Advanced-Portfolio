...
useTexture.preload('/lanyard/Charan_Kumar_Id.png?v=3');
...
function Band({ maxSpeed = 50, minSpeed = 0, isMobile = false, isDark = false }) {
    ...
    const customCardTexture = useTexture('/lanyard/Charan_Kumar_Id.png?v=3');
