                ...
                <AnimatePresence>
                    {isExpanded && (
                        ...
                        >
                            ...
                            <div className="flex-1 flex flex-col px-[8vw] pt-[4vh] pb-[2vh] justify-between relative">
                                <div className="flex flex-col justify-center max-w-[1600px] w-full mx-auto relative mb-[8vh]">
                                    ...
                                    <div className="w-full grid grid-cols-4 gap-x-[5vw] gap-y-[4vh]">
                                        ...
                                        <FooterColumn title={t('localTime')}>
                                            ...
                                            <a
                                                ...
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="text-muted-foreground hover:text-foreground transition-colors group/link"
                                            >
                                                Udupi, India
                                            </a>
                                        </FooterColumn>
                                ...
                                <div className="mt-auto overflow-hidden flex-shrink-0 relative h-[25vh] md:h-[30vh] flex items-end justify-center">
                                    <motion.h2
                                        initial={{ opacity: 0, y: "100%" }}
                                        animate={isAboutExpanded ? { opacity: 0, y: "120%" } : { opacity: 1, y: "20%" }}
                                        transition={{ duration: 0.6, ease: [0.16, 1, 0.3, 1] }}
                                        className="text-[12vw] md:text-[14vw] font-black leading-none text-zinc-900 dark:text-white tracking-tighter select-none text-center"
                                    >
                                        CHARAN
                                    </motion.h2>
                                </div>
